...
class DCGan():
    ...
    def build(self):
        ...
        with tf.variable_scope('gen_fc') as scope:
            self.fcg = tf.nn.relu(tf.bias_add(tf.matmul(self.ginput,self.fcg_w), self.fcg_b))
        ...
        with tf.variable_scope('gen_dconv1') as scope:
            self.dconv1 = tf.nn.relu( tf.bias_add(tf.nn.conv2d_transpose(self.fcgb,
                                                              self.dconv1_w,
        ...
        with tf.variable_scope('gen_dconv2') as scope:
            self.dconv2 = tf.nn.relu( tf.bias_add(tf.nn.conv2d_transpose(self.dconv1b,
                                                              self.dconv2_w,
        ...
        with tf.variable_scope('gen_dconv3') as scope:
            self.dconv3 = tf.nn.relu( tf.bias_add(tf.nn.conv2d_transpose(self.dconv2b,
                                                              self.dconv3_w,
        ...
        with tf.variable_scope('gen_dconv4') as scope:
            self.dconv4 = tf.nn.tanh(tf.bias_add(tf.nn.conv2d_transpose(self.dconv3b,
                                                              self.dconv4_w,
        ...
        with tf.variable_scope('dis_conv1') as scope:
            self.conv1 = tf.bias_add(tf.nn.conv2d(self.dinput, self.conv1_w, [1,2,2,1], 'SAME'), self.conv1_b)
        ...
        with tf.variable_scope('dis_conv2') as scope:
            self.conv2 = tf.bias_add(tf.nn.conv2d(self.conv1b, self.conv2_w, [1,2,2,1], 'SAME') , self.conv2_b)
        ...
        with tf.variable_scope('dis_conv3') as scope:
            self.conv3 = tf.bias_add(tf.nn.conv2d(self.conv2b, self.conv3_w, [1,2,2,1], 'SAME'), self.conv3_b)
        ...
        with tf.variable_scope('dis_conv4') as scope:
            self.conv4 = tf.bias_add(tf.nn.conv2d(self.conv3b, self.conv4_w, [1,2,2,1], 'SAME'), self.conv4_b)
        ...
        with tf.variable_scope('dis_fc') as scope:
            ...
            self.fcd = tf.bias_add(tf.matmul(self.fcd_in, self.fcd_w), self.fcd_b)
